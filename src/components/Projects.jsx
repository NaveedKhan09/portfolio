    ...
    return(
        <div className="Projects" id='projects'>
            ...
            <div className="projects_container">
                ...
                {/*serum site*/}
                <ProjectCard title="Serum site" description="Glow serum site built in React, Tailwind css and Frammer motion" projectImage="images/serum.png" LiveDemo="https://serum-site.vercel.app/" GithubCode="https://github.com/NaveedKhan09/serum-site" />
                {/*Cooking hub*/}
